...
./configure --with-features=huge --enable-multibyte --enable-pythoninterp=yes --with-python-config-dir=/usr/lib/python${PYTHON2VER}/config-x86_64-linux-gnu --enable-python3interp=yes --with-python3-config-dir=/usr/lib/python${PYTHON3VER}/config-${PYTHON3VER}m-x86_64-linux-gnu --enable-perlinterp=yes --enable-gui=gtk2 --enable-cscope --prefix=/usr/local --with-tlib=ncurses
